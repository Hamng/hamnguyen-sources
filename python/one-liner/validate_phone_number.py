# -*- coding: utf-8 -*-
"""
Created on Fri Mar  1 10:29:14 2019

@author: Ham

HackerRanch Challenge: Validating phone numbers

Let's dive into the interesting topic of regular expressions!
You are given some input,
...
for _ in range(int(input().strip())):
    print("YES" if re.match(r"[789]\d{9}$", input().strip()) else "NO")
