# -*- coding: utf-8 -*-
"""
Created on Thu Feb 28 04:58:38 2019

@author: Ham

HackerRanch Challenge: The Captain's Room
...
The total number of tourists or the total number of
groups of families is not known to you.
...
if __name__ == '__main__':
    input()
    c = collections.Counter(map(int, input().strip().split()))
    #print(c)
