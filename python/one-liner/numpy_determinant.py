# -*- coding: utf-8 -*-
"""
Created on Wed Feb 27 08:55:58 2019

@author: Ham

HackerRanch Challenge: Linear Algebra
...
if __name__ == '__main__':
    ...
    a = [list(map(float, STDIN_SIO.readline().strip().split()))
         for _ in range(int(STDIN_SIO.readline()))]
    print(a)
