# -*- coding: utf-8 -*-
"""
Created on Sat Mar  9 22:32:34 2019

@author: Ham

HackerRanch Challenge: Classes: Dealing with Complex Numbers
...
the output should be in the following format: A + Bi
...
For reading about classes, refer here.

Methods with a double underscore before and after their name are considered
as built-in methods.
They are used by interpreters and are generally used in the implementation
of overloaded operators or other built-in functionality.
...
class Complex:
    ...
    def __truediv__(self, no):
        ...
        return Complex(
            (self.real * no.real + self.imaginary * no.imaginary) / den,
            (self.imaginary * no.real - self.real * no.imaginary) / den
        )
