...
HackerRanch Challenge: HTML Parser - Part 1

HTML
Hypertext Markup Language is a standard markup language
...
If an attribute has no attribute value
then simply print the name of the attribute value as None.
...
in order of their occurrence from top to bottom in the given snippet.
