# -*- coding: utf-8 -*-
"""
Created on Thu Sep 17 10:27:32 2020

@author: Ham

Facebook Coding Practice: [Recursion] Change in a Foreign Currency
...
def canGetExactChange(targetMoney, denominations):
  ...
  #denominations = itertools.dropwhile(lambda x:x > targetMoney, sorted(denominations, reverse=True))
  #print(targetMoney, list(denominations))
  #for den in denominations:
  #  print(targetMoney, '=', den, '* ', end='')
  #  coins, targetMoney = divmod(targetMoney, den)
  #  print(coins, '+', targetMoney)
  #  if targetMoney == 0:
  #    break
  #return targetMoney == 0

  # Mind-boggling 1-liner version
  return [targetMoney for d in itertools.dropwhile(lambda x:x > targetMoney,
                                    sorted(denominations, reverse=True))
   if (targetMoney := divmod(targetMoney, d)[1]) >= 0
   ][-1] == 0
