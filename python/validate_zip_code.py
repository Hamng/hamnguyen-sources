# -*- coding: utf-8 -*-
"""
Created on Tue Feb 26 19:20:53 2019

@author: Ham

HackerRanch Challenge: Validating Postal Codes
...
In other words, an alternating repetitive digit pair is formed
...
regex_integer_in_range should match only integers range 100000 to 999999 inclusive

regex_alternating_repetitive_digit_pair should find the
alternating repetitive digits pairs in a given string.

Both these regular expressions will be used by the provided code template to
check if the input string  is a valid postal code using the following expression:
