# -*- coding: utf-8 -*-
"""
Created on Fri Mar  1 22:50:35 2019

@author: Ham

HackerRanch Challenge: itertools.combinations_with_replacement
...
if __name__ == '__main__':
    ...
    # sorted(s) so that .combinations_with_replacement() will also be sorted
    s = sorted(s)
    print(*("".join(t) for t in itertools.combinations_with_replacement(s, int(k))),
          sep="\n")
